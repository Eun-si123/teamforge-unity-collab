...
Please keep changes focused when practical and describe enough testing for reviewers to understand what was actually verified.
...
Describe what you actually tested. Please distinguish between automated tests, manual tests, and behavior that was not tested.

Examples:

- Unity Test Runner tests added or executed
- two-Editor synchronization test
- disconnect / reconnect test
- project transfer / interrupted resume test
- malformed or mismatched input test
...
- [ ] Locking / ownership / conflict resolution
- [ ] Recovery / rollback / data integrity
- [ ] Package installation / update behavior
- [ ] None of the above

If a sensitive area is affected, explain the failure modes you considered and how they were tested.
...
AI use does not reduce your responsibility for the submission. Please do not submit generated output that you have not meaningfully reviewed.

Optional notes about AI assistance:

<!-- Example: Used an AI coding assistant for the initial implementation and test ideas; manually reviewed the diff and ran X/Y/Z tests. -->
